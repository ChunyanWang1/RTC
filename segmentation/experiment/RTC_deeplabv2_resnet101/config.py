...
config_dict = {
		'EXP_NAME': 'RTC_deeplabv2_resnet101',
		'GPUS': 1,
		'TRAIN_LIST':'/opt/data/private/wseg-master/voc12/train_aug_id.txt',
		...
		'DATA_RANDOM_V': 10,
		'DATA_RANDOMFLIP': 0.5,
		'DATA_PSEUDO_GT': 'your_pseudo_label_dir',#'/opt/data/private/wseg-master/segmentation/data/pseudo-mask-22/pseudo_wpl'
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'], 'model/RTC_deeplabv2_resnet101/deeplabv2_resnet101_VOCDataset_itr20000_all.pth')#deeplabv2_resnet101_VOCDataset_itr20000_all.pth
